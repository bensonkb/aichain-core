...
8. Upload gitian build to [aichain.me](https://download.aichain.me/)

9. Re-verify the uploads (make sure that downloading them, their checksums are ok)

10. Create a [GitHub release](https://github.com/AICHAIN-CORE/aichain/releases) 


## After Release

11. Update version number on www.aichain.me
